...
example/src/%.o: ../example/src/%.c
	...
	arm-none-eabi-gcc -D__MULTICORE_NONE -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -D__REDLIB__ -DCORE_M4 -I"C:\Users\Alan\Leo\UBA\Embebidos\TP3_sistemas_embebidos\lpc_chip_43xx\inc" -I"C:\Users\Alan\Leo\UBA\Embebidos\TP3_sistemas_embebidos\lpc_board_nxp_lpcxpresso_4337\inc" -I"C:\Users\Alan\Leo\UBA\Embebidos\TP3_sistemas_embebidos\freertos_examples_1_to_9\example\inc" -I"C:\Users\Alan\Leo\UBA\Embebidos\TP3_sistemas_embebidos\freertos_examples_1_to_9\freertos\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fsingle-precision-constant -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
